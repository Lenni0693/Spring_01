        ...
        .then(user => {
            temp = `
                <tr>
                    ...
                    <td>${user.age}</td>
                    <td>${user.email}</td>
                    <td>${user.userRoles.map(e => " " + e.name)}</td>
                </tr>
            `;
            ...
            $(function (){
                ...
                for (let i = 0; i < user.roles.length; i++) {
                    ...
                    // проверяем админ или обычный смертный
                    if (role === "ROLE_ADMIN") {
                        isUser = false;
                    }
                }
                // в заивисимости от роли делаем видим то или иное поле
                if (isUser) {
...
// панель в зависимости от прав пользователя
...
// получаем форму добавления пользователя
...
// модальное окно удаление и изменений
